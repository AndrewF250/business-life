/** Shared Atelier HTML shell helpers */
...
function shell({ title, description, active, body, robots = 'index, follow', page = 'page' }) {
  return `<!DOCTYPE html>
<html lang="ru">
<head>
  <meta charset="UTF-8">
...
${body}
  ...
  <script src="js/atelier-residents.js"></script>
  <script src="js/atelier-motion.js"></script>
</body>
</html>`;
}

module.exports = { escapeHtml, shell, navLinks, FORM };
